...
public class Key extends GameObject {
	...
	private final static String TEXTURE_FILE = "objects/chest/key.png";
	
	public Key(GameWorldManager gameWorldManager, float x, float y) {
		...
		animation.put(State.IDLE, 		Utils.createAnimation(getTexture(), 14f / Constants.PPM, 0, 7, 0, 96, 96));
